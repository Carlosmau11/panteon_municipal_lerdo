...
<head>
    ...
    <title>Eliminar Panteon Municipal</title>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-6 offset-sm-3">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <form action="../../app/model/functions_db.php" method="POST">
                            <input type="hidden" name="accion" value="eliminar_panteon_municipal">
